...
ggsave(file = "fig/figure_S7.png", width = 12, height = 10, dpi = 500)
```
...
loo_results_lnRR <- loo_results_lnRR %>%
  mutate(
   study_id = case_when(
      study_id == "Hallsson_et_al_2012_2" ~ "Hallson_et_al_2012",
      study_id == "Gibbin_et_al_2017_1" ~ "Gibbin_et_al_2017a",
      study_id == "Gibbin_et_al_2017_2" ~ "Gibbin_et_al_2017b",
      study_id == "Partridge_et_al_1994" ~ "Partridge_et_al_1994a",
      TRUE ~ study_id
    )
  )
...
ggsave(file = "fig/figure_S13.png", width = 14, height = 12, dpi = 500)
``` 
...
loo_results_lnVR <- loo_results_lnVR %>%
  mutate(
   study_id = case_when(
      study_id == "Hallsson_et_al_2012_2" ~ "Hallson_et_al_2012",
      study_id == "Gibbin_et_al_2017_1" ~ "Gibbin_et_al_2017a",
...
ggsave(file = "fig/figure_S14.png", width = 14, height = 12, dpi = 500)
``` 
...
ggsave(file = "fig/figure_S15.png", width = 12, height = 7, dpi = 500)
```
...
ggsave(file = "fig/figure_S17.png", width = 12, height = 10, dpi = 500)
```
