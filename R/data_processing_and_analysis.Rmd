...
# R2
r2(lnCVR_model_warm_gen_common_garden)
...
# R2
r2(lnVR_model_pub_constant_increasing)
...
p <- ggplot() +
  ...
  # 
  # geom_errorbar(   ##### Add this part to visualise mean effects per study
  #   data = study_sum,
  #   aes(
  #     y = ref_facet,
  #     xmin = lower_CI,
...
ggsave(file = "fig/figure_S7.png", width = 10, height = 10, dpi = 500)
```
...
ggsave(file = "fig/figure_S9.png", width = 10, height = 10, dpi = 500)
```
...
ggsave(file = "fig/figure_S10.png", width = 10, height = 10, dpi = 500)
```
...
ggsave(file = "fig/figure_S12.png", width = 10, height = 10, dpi = 500)
```
...
ggsave(file = "fig/figure_S15.png", width = 10, height = 10, dpi = 500)
```
...
ggsave(file = "fig/figure_S18.png", width = 10, height = 10, dpi = 500)
```
...
ggsave(file = "fig/figure_S19.png", width = 10, height = 10, dpi = 500)
```
